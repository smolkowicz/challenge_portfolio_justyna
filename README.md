...
*2. Funkcjonalności aplikacji:*
  ...
  - możliwość dodania szczegółowego raportu meczowego, który odnosi się do konkretnego zawodnika i konkretnego meczu ( np: w raporcie można dodać informacje dot. zachowań zawodnika na boisku, strategii gry, zachowań wobec innych graczy lub czym zawodnik się wyróżnia )
